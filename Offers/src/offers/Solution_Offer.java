...
public class Solution_Offer {
	...
	public static void main(String[] args) {
		...
		String bb = "a";
		String aa = "ab*a";
		System.out.println(new Solution_Offer().match(bb.toCharArray(), aa.toCharArray()));
	...
	public void sort(String str, ArrayList<String> list) {
	...
	public boolean newHasPath(char[] matrix, int rows, int cols, char[] str) {
		...
		/*
		 * public static void fill(boolean[] a, boolean val) { for (int i = 0,
		 * len = a.length; i < len; i++) a[i] = val; }
		 */
		Arrays.fill(flags, false);
